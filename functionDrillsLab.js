...
function faveColorFinder(color){
  if (color === "red"){
    ...
    return console.log('green is a sold favorite color')
  } if (color === "black"){
...
emailCheck("somebody33@email.com")
////////////////// PROBLEM 13 ////////////////////
/*
...
//CODE HERE
function frogger(gold){
  const cocoFrog = gold / 3;
  return cocoFrog;
}

let totalFrogs = frogger(20);
...
//CODE HERE
function frogger2(gold){
  const cocoFrog = Math.floor(gold / 3);
  return cocoFrog;
}

let totalFrogs2 = frogger2(20);
